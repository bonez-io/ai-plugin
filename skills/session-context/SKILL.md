...
- **rules** — the org's standing instructions (repo rules, review rules, commands). Follow them the way you follow a CLAUDE.md: they encode how THIS org works and outrank your generic defaults.
